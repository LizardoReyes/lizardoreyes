...
### Java Backend Developer from Perú ☕🇵🇪

Soy **Java Backend Developer** especializado en el desarrollo de **APIs y microservicios con Spring Framework**.  
Me enfoco en construir aplicaciones **escalables, mantenibles y orientadas a buenas prácticas de arquitectura**.

Actualmente trabajo con tecnologías del ecosistema **Java + Spring**, integración de servicios, mensajería y bases de datos relacionales.
...
![Drools](https://img.shields.io/badge/Drools-CC0000?style=for-the-badge)
